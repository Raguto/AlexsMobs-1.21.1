...
public class EmeraldsForItemsTrade implements VillagerTrades.ItemListing {
    ...
    public MerchantOffer getOffer(Entity p_221182_1_, RandomSource p_221182_2_) {
        ...
        return new MerchantOffer(new ItemCost(lvt_3_1_.getItem(), lvt_3_1_.getCount()), new ItemStack(Items.EMERALD, this.count), this.maxUses, this.xpValue, this.priceMultiplier);
    }
}