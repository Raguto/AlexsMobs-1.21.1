...
@OnlyIn(Dist.CLIENT)
// @Mod.EventBusSubscriber removed - use direct registration(modid = AlexsMobs.MODID, value = Dist.CLIENT)
public class ClientProxy extends CommonProxy {
    ...
    public static void onItemColors(RegisterColorHandlersEvent.Item event) {
        ...
        if(AMItemRegistry.STRADDLEBOARD.isBound()){
            event.register((stack, colorIn) -> colorIn < 1 ? -1 : net.minecraft.world.item.component.DyedItemColor.getOrDefault(stack, -1), AMItemRegistry.STRADDLEBOARD.get());
        }else{
    ...
    public void clientInit() {
        ...
        try {
            ...
            ItemProperties.register(AMItemRegistry.HEMOLYMPH_BLASTER.get(), ResourceLocation.parse("empty"), (stack, p_239428_1_, p_239428_2_, j) -> {
            ...
            ItemProperties.register(AMItemRegistry.TARANTULA_HAWK_ELYTRA.get(), ResourceLocation.parse("broken"), (stack, p_239428_1_, p_239428_2_, j) -> {
                return ItemTarantulaHawkElytra.isUsable(stack) ? 0.0F : 1.0F;
            });
            ItemProperties.register(AMItemRegistry.SHIELD_OF_THE_DEEP.get(), ResourceLocation.parse("blocking"), (stack, p_239421_1_, p_239421_2_, j) -> {
                return p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getUseItem() == stack ? 1.0F : 0.0F;
            });
            ItemProperties.register(AMItemRegistry.SOMBRERO.get(), ResourceLocation.parse("silly"), (stack, p_239421_1_, p_239421_2_, j) -> {
                return AlexsMobs.isAprilFools() ? 1.0F : 0.0F;
            });
            ItemProperties.register(AMItemRegistry.TENDON_WHIP.get(), ResourceLocation.parse("active"), (stack, p_239421_1_, holder, j) -> {
                return ItemTendonWhip.isActive(stack, holder) ? 1.0F : 0.0F;
            });
            ItemProperties.register(AMItemRegistry.PUPFISH_LOCATOR.get(), ResourceLocation.parse("in_chunk"), (stack, world, entity, j) -> {
            ...
            ItemProperties.register(AMItemRegistry.SKELEWAG_SWORD.get(), ResourceLocation.parse("blocking"), (stack, p_239421_1_, p_239421_2_, j) -> {
                return p_239421_2_ != null && p_239421_2_.isUsingItem() && p_239421_2_.getUseItem() == stack ? 1.0F : 0.0F;
            });
        } catch (Exception e) {
    ...
    private static void onBakingCompleted(final ModelEvent.ModifyBakingResult e) {
        ...
        for (var entry : e.getModels().entrySet()) { ModelResourceLocation id = entry.getKey();
