...
public class EntitySoulVulture extends Monster implements FlyingAnimal {
    ...
    public static final net.minecraft.resources.ResourceKey<net.minecraft.world.level.storage.loot.LootTable> SOUL_LOOT = 
        net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, 
            ResourceLocation.fromNamespaceAndPath("alexsmobs", "entities/soul_vulture_heart"));
