...
public class EntityTiger extends Animal implements ICustomCollisions, IAnimatedEntity, NeutralMob, ITargetsDroppedItems {
    ...
    public boolean canTargetItem(ItemStack stack) {
        return stack.has(net.minecraft.core.component.DataComponents.FOOD) && stack.getItem().getFoodProperties(stack, null) != null && true /* TODO 1.21: isMeat() check needs food component */ && stack.getItem() != Items.ROTTEN_FLESH;
    }
    ...
    public void onGetItem(ItemEntity e) {
        ...
        if (stack.has(net.minecraft.core.component.DataComponents.FOOD) && stack.getItem().getFoodProperties(stack, null) != null && true /* TODO 1.21: isMeat() check needs food component */ && stack.getItem() != Items.ROTTEN_FLESH) {
