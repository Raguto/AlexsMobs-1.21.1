...
public class EntityTasmanianDevil extends Animal implements IAnimatedEntity, ITargetsDroppedItems {
    ...
    public void killed(ServerLevel world, LivingEntity entity) {
        if(this.getRandom().nextBoolean() && (entity instanceof Animal || entity.getType().is(net.minecraft.tags.EntityTypeTags.ARTHROPOD) /* TODO: verify tag */)){
    ...
    public boolean isFood(ItemStack stack) {
        return stack.has(net.minecraft.core.component.DataComponents.FOOD) && stack.getItem().getFoodProperties(stack, null) != null && true /* TODO 1.21: isMeat() check needs food component */ && !stack.is(AMTagRegistry.TASMANIAN_DEVIL_HOWLING_FOODS);
    }
    ...
    public boolean canTargetItem(ItemStack stack) {
        return stack.has(net.minecraft.core.component.DataComponents.FOOD) && stack.getItem().getFoodProperties(stack, null) != null && true /* TODO 1.21: isMeat() check needs food component */ || stack.getItem() == Items.BONE;
    }
