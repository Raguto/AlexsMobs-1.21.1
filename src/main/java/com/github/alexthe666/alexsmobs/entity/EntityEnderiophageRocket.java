...
public class EntityEnderiophageRocket extends FireworkRocketEntity {
    ...
    public EntityEnderiophageRocket(Level worldIn, double x, double y, double z, ItemStack givenItem) {
        ...
        this.setPos(x, y, z);
        if (!givenItem.isEmpty() && false /* TODO 1.21: hasTag() removed - use components */) {
            // TODO 1.21: DATA_ID_FIREWORKS_ITEM is private in FireworkRocketEntity
        ...
        // TODO 1.21: lifetime is private in FireworkRocketEntity
    ...
    public EntityEnderiophageRocket(Level p_i47367_1_, ItemStack p_i47367_2_, LivingEntity p_i47367_3_) {
        ...
        // TODO 1.21: DATA_ATTACHED_TO_TARGET is private in FireworkRocketEntity
