...
public class AnteaterAIRaidNest extends MoveToBlockGoal {
    ...
    public static final ResourceLocation ANTEATER_REWARD = ResourceLocation.fromNamespaceAndPath("alexsmobs", "gameplay/anteater_reward");
    ...
    private void breakHiveEffect(){
        if (net.neoforged.neoforge.event.EventHooks.canEntityGrief(this.anteater.level(), this.anteater)) {
