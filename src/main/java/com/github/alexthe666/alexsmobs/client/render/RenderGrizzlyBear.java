...
public class RenderGrizzlyBear extends MobRenderer<EntityGrizzlyBear, ModelGrizzlyBear> {
    ...
    private static final ResourceLocation TEXTURE_SNOWY = ResourceLocation.parse("alexsmobs:textures/entity/grizzly_bear_snowy.png");
    public static final ResourceLocation TEXTURE_FREDDY = ResourceLocation.parse("alexsmobs:textures/entity/grizzly_bear_freddy.png");
    private static final ResourceLocation TEXTURE_FREDDY_EYES = ResourceLocation.parse("alexsmobs:textures/entity/grizzly_bear_freddy_eyes.png");
