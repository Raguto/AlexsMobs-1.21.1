...
public class RenderMungus extends MobRenderer<EntityMungus, ModelMungus> {
    ...
    private static final ResourceLocation BEAM_TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/mungus_beam.png");
    private static final ResourceLocation TEXTURE_BEAM_OVERLAY = ResourceLocation.parse("alexsmobs:textures/entity/mungus_beam_overlay.png");
    private static final ResourceLocation TEXTURE_SACK_OVERLAY = ResourceLocation.parse("alexsmobs:textures/entity/mungus_sack.png");
    private static final ResourceLocation TEXTURE_SHOES = ResourceLocation.parse("alexsmobs:textures/entity/mungus_shoes.png");
    ...
    private static void vertex(VertexConsumer p_229108_0_, Matrix4f p_229108_1_, Matrix3f p_229108_2_, float p_229108_3_, float p_229108_4_, float p_229108_5_, int p_229108_6_, int p_229108_7_, int p_229108_8_, float p_229108_9_, float p_229108_10_) {
        p_229108_0_.addVertex(p_229108_5_, 0.0F, 0.0F).setColor((int)(p_229108_6_ * 255), (int)(p_229108_7_ * 255), (int)(p_229108_8_ * 255), (int)(255 * 255)).setUv(p_229108_9_, p_229108_10_).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(240 & 0xFFFF, 240 >> 16).setNormal(0.0F, 1.0F, 0.0F);
    }
    ...
    protected void setupRotations(EntityMungus entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
        if (entityLiving.deathTime > 0) {
            ...
            super.setupRotations(entityLiving, matrixStackIn, ageInTicks, rotationYaw, partialTicks, 1.0F);
        }
    }
    ...
    static class MungusSackLayer extends RenderLayer<EntityMungus, ModelMungus> {
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntityMungus entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            if (entitylivingbaseIn.getBeamTarget() != null) {
                ...
                this.getParentModel().renderToBuffer(matrixStackIn, beam, 240, LivingEntityRenderer.getOverlayCoords(entitylivingbaseIn, 0));
            }
            String s = ChatFormatting.stripFormatting(entitylivingbaseIn.getName().getString());
            if (s != null && s.toLowerCase().contains("drip")) {
