...
public class RenderRhinoceros extends MobRenderer<EntityRhinoceros, ModelRhinoceros> {
    ...
    private static final ResourceLocation TEXTURE_ANGRY = ResourceLocation.parse("alexsmobs:textures/entity/rhinoceros_angry.png");
    private static final ResourceLocation TEXTURE_POTION = ResourceLocation.parse("alexsmobs:textures/entity/rhinoceros_potion.png");
