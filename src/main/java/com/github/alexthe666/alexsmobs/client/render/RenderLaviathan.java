...
public class RenderLaviathan extends MobRenderer<EntityLaviathan, ModelLaviathan> {
    ...
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.parse("alexsmobs:textures/entity/laviathan_glow.png");
    ...
    private static final ResourceLocation TEXTURE_GEAR = ResourceLocation.parse("alexsmobs:textures/entity/laviathan_gear.png");
    private static final ResourceLocation TEXTURE_HELMET = ResourceLocation.parse("alexsmobs:textures/entity/laviathan_helmet.png");
