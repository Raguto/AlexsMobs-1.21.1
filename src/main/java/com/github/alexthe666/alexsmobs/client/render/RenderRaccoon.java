...
public class RenderRaccoon extends MobRenderer<EntityRaccoon, ModelRaccoon> {
    ...
    private static final ResourceLocation TEXTURE_RIGBY = ResourceLocation.parse("alexsmobs:textures/entity/raccoon_rigby.png");
    private static final ResourceLocation TEXTURE_BANDANA = ResourceLocation.parse("alexsmobs:textures/entity/raccoon_bandana.png");

    // Color arrays for dye colors (replacement for Sheep.getColorArray which was removed in 1.21)
        ...
        public void render(PoseStack p_225628_1_, MultiBufferSource p_225628_2_, int p_225628_3_, EntityRaccoon raccoon, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
            if (raccoon.getColor() != null && !raccoon.isInvisible()) {
                ...
                if (raccoon.hasCustomName() && "jeb_".equals(raccoon.getName().getContents())) {
                    ...
                    float[] lvt_20_1_ = getColorArray(DyeColor.byId(lvt_17_1_));
                    float[] lvt_21_1_ = getColorArray(DyeColor.byId(lvt_18_1_));
                    ...
                    float[] lvt_14_2_ = getColorArray(raccoon.getColor());
