...
public class RenderVoidPortal extends EntityRenderer<EntityVoidPortal> {
    private static final ResourceLocation TEXTURE_0 = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/portal_idle_0.png");
    private static final ResourceLocation TEXTURE_1 = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/portal_idle_1.png");
    private static final ResourceLocation TEXTURE_2 = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/portal_idle_2.png");
    private static final ResourceLocation TEXTURE_SHATTERED_0 = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/shattered/portal_idle_0.png");
    private static final ResourceLocation TEXTURE_SHATTERED_1 = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/shattered/portal_idle_1.png");
    private static final ResourceLocation TEXTURE_SHATTERED_2 = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/shattered/portal_idle_2.png");
    ...
    public RenderVoidPortal(EntityRendererProvider.Context renderManagerIn) {
        ...
        for(int i = 0; i < 10; i++){
            TEXTURE_PROGRESS[i] = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/portal_grow_" + i + ".png");
            TEXTURE_SHATTERED_PROGRESS[i] = ResourceLocation.parse("alexsmobs:textures/entity/void_worm/portal/shattered/portal_grow_" + i + ".png");
        }
    }
