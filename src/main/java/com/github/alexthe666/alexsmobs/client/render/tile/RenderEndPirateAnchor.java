...
public class RenderEndPirateAnchor<T extends TileEntityEndPirateAnchor> implements BlockEntityRenderer<T> {
    ...
    protected static final ResourceLocation TEXTURE_ANCHOR = ResourceLocation.parse("alexsmobs:textures/entity/end_pirate/anchor.png");
    protected static final ResourceLocation TEXTURE_ANCHOR_GLOW = ResourceLocation.parse("alexsmobs:textures/entity/end_pirate/anchor_glow.png");
