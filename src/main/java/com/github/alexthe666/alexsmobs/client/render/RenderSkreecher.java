...
public class RenderSkreecher extends MobRenderer<EntitySkreecher, ModelSkreecher> {
    ...
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.parse("alexsmobs:textures/entity/skreecher_glow.png");
    ...
    static class LayerScorch extends RenderLayer<EntitySkreecher, ModelSkreecher> {
        ...
        public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EntitySkreecher entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.getParentModel().renderToBuffer(matrixStackIn, scorch, 240, LivingEntityRenderer.getOverlayCoords(entitylivingbaseIn, 0));
        }
    }
}
