...
public class RenderSpectre extends MobRenderer<EntitySpectre, ModelSpectre> {
    private static final ResourceLocation TEXTURE_BONE = ResourceLocation.parse("alexsmobs:textures/entity/spectre_bone.png");
    private static final ResourceLocation TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/spectre.png");
    private static final ResourceLocation TEXTURE_EYES = ResourceLocation.parse("alexsmobs:textures/entity/spectre_glow.png");
    private static final ResourceLocation TEXTURE_LEAD = ResourceLocation.parse("alexsmobs:textures/entity/spectre_lead.png");
