...
public class RenderGiantSquid extends MobRenderer<EntityGiantSquid, ModelGiantSquid> {
    ...
    private static final ResourceLocation TEXTURE_BLUE = ResourceLocation.parse("alexsmobs:textures/entity/giant_squid_blue.png");
    private static final ResourceLocation TEXTURE_DEPRESSURIZED = ResourceLocation.parse("alexsmobs:textures/entity/giant_squid_depressurized.png");
