...
public class BeachedCachalotWhaleSpawner {
    ...
    private BlockPos func_221244_a(BlockPos p_221244_1_, int p_221244_2_) {
        ...
        for(int i = 0; i < 10; ++i) {
            ...
            if (AMWorldRegistry.testBiome(BiomeConfig.cachalot_whale_beached_spawns, world.getBiome(blockpos1)) && true /* TODO 1.21: NaturalSpawner.isSpawnPositionOk signature changed */) {
                blockpos = blockpos1;
                break;
            }
        }
