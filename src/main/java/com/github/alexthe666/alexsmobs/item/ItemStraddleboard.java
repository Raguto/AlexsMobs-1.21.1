...
// TODO 1.21: DyeableLeatherItem changed, need to implement manually
public class ItemStraddleboard extends Item {
    ...
    public int getColor(ItemStack p_200886_1_) {
        CompoundTag lvt_2_1_ = null /* TODO 1.21: getTagElement removed - use DataComponents */;
        return lvt_2_1_ != null && lvt_2_1_.contains("color", 99) ? lvt_2_1_.getInt("color") : 0XADC3D7;
    }

    // TODO 1.21: canApplyAtEnchantingTable removed - use enchantment tags
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (raytraceresult.getType() == HitResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == HitResult.Type.BLOCK) {
                ...
                boatentity.setDefaultColor(!false /* TODO 1.21: hasCustomColor removed - use DyedItemColor component */);
